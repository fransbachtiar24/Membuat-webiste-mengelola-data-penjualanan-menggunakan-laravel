        ...
        <div class="card-body">
            <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-9">
                        <input type="number" class="form-control" name="stok" placeholder="Masukkan Jumlah Stok"><br>
                        @error('stok')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-9">
                        <input type="number" class="form-control" name="harga" placeholder="Masukkan Jumlah Harga"><br>
                        @error('harga')
                            <div class="text-danger">{{ $message }}</div><br>
                        @enderror
                    </div>
                    <div class="col-lg-3">
                        <label for="nameInput" class="form-label">Foto Produk</label>
                    </div>
                    <div class="col-lg-9">
