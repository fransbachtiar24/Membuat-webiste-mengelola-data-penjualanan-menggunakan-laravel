                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="nama_produk" placeholder="Masukkan Nama Produk"
                            value="{{ old('nama_produk') ?? $produk->nama_produk }}"><br>
                    </div>
                    <div class="col-lg-3">
                        <label for="nameInput" class="form-label">Brand</label>
                    </div>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="brand" placeholder="Masukkan Nama Brand"
                            value="{{ old('nama_produk') ?? $produk->brand }}"><br>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <select class="form-select mb-3" aria-label="Default select example" name="kategori_id">
                            <option selected>Pilih Jenis Produk</option> <br>
                            @foreach ($kategori as $item)
                                <option value="{{ $item->id }}"
                                    {{ $item->id == $produk->ketegori_id ? 'selected' : null }}>
                    ...
                    <div class="col-lg-9">
                        <select class="form-select mb-3" name="ukuran" aria-label="Default select example">
                            ...
                            <option value="S" @if ($produk->ukuran == 'S') selected @endif>S</option>
                            <option value="M" @if ($produk->ukuran == 'M') selected @endif>M</option>
                            <option value="L" @if ($produk->ukuran == 'L') selected @endif>L</option>
                            <option value="XL" @if ($produk->ukuran == 'XL') selected @endif>XL</option>
                            <option value="XXL" @if ($produk->ukuran == 'XXL') selected @endif>XXL</option>
                        </select>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <select class="form-select mb-3" name="gender" aria-label="Default select example">
                            ...
                            <option value="P" @if ($produk->gender == 'P') selected @endif>Perempuan</option>
                            <option value="L" @if ($produk->gender == 'L') selected @endif>Laki-Laki</option>
                        </select>
                    </div>
                    <div class="col-lg-3">
                        <label for="nameInput" class="form-label">Stok</label>
                    </div>
                    <div class="col-lg-9">
                        <input type="number" class="form-control" name="stok" placeholder="Masukkan Jumlah Stok"
                            value="{{ old('stok') ?? $produk->stok }}"><br>
                    </div>
                    <div class="col-lg-3">
                        <label for="nameInput" class="form-label">Harga</label>
                    </div>
                    <div class="col-lg-9">
                        <input type="number" class="form-control" name="harga" placeholder="Masukkan Jumlah Harga"
                            value="{{ old('harga') ?? $produk->harga }}"><br>
                    </div>
                    <div class="text-end">
