...
<head>
    ...
    <link href="{{ asset('assets/css/toggle.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        @auth
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="{{ url('profiluser') }}">
                                    <i class=" bx bx-user"></i> profile
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="{{ url('shopping') }}">
                                    <i class=" bx bxs-cart-alt"></i> Shopping
                                </a>
                            </li>
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="/login">
                                    <i class="bx bxs-lock"></i> login
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="/register">
                                    <i class=" bx bxs-lock-open"></i> Register
                                </a>
                            </li>
                        @endauth
                    </ul>
