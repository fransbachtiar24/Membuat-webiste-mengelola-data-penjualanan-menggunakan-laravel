...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('laporan/' . $modal->id) }}" method="POST">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-9">
                        <input type="date" class="form-control" name="tanggal" value="{{ $modal->tanggal }}">
                        @error('tanggal')
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="nama_pelanggan"
                            placeholder="Masukkan Nama Pelanggan" value="{{ $modal->nama_pelanggan }}">
                    ...
                    <div class="col-lg-9">
                        <select class="form-select mb-3" aria-label="Default select example" name="produk_id">
                            <option selected value="{{ $modal->produk_id }}">Nama Produk</option>
                    ...
                    <div class="col-lg-9">
                        <select class="form-select mb-3" name="jenis_produk" aria-label="Default select example">
                            <option selected value="{{ $modal->jenis_produk }}">Pilih Produk</option> <br>
                    ...
                    <div class="col-lg-9">
                        <input value="{{ $modal->brand }}" type="text" class="form-control" name="brand"
                            placeholder="Masukkan Brand"><br>
                        @error('brand')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-9">
                        <select class="form-select mb-3" name="ukuran" aria-label="Default select example">
                            <option selected value="{{ $modal->ukuran }}">Pilih Ukuran</option> <br>
                    ...
                    <div class="col-lg-9">
                        <select class="form-select mb-3" name="gender" aria-label="Default select example">
                            <option selected value="{{ $modal->gender }}">Jenis Kelamin</option>
                    ...
                    <div class="col-lg-9">
                        <input type="number" class="form-control" name="harga" value="{{ $modal->harga }}">
                        <br>
                        @error('harga')
                            <div class="text-danger">{{ $message }}</div><br>
                        @enderror
